...
const questions = [
  {
    ...
    name: "Behavioral",
    description:
      "Questions focusing on the candidate's behavior in different situations.",
  },
  {
    id: 2,
    name: "Technical",
    description:
      "Questions focusing on the candidate's technical skills and knowledge.",
  },
  {
    id: 3,
    name: "Management",
    description:
      "Questions focusing on the candidate's management skills and experience.",
  },
];
...
const interviewers = [
  {
    ...
    prompt:
      "Evaluate the candidate's abilities in software engineering. Prioritize their problem-solving techniques, coding proficiency, and grasp of software principles. In behavioral and technical discussions, assess their insights and reasoning. For questions outside their expected knowledge, gauge their capacity to adapt and employ critical thinking.",
  },
  {
    id: "Richard",
    name: "Richard",
    ...
    prompt:
      "Analyze the candidate's proficiency in product management. Focus on their articulation of product visions, how they handle product backlogs, and their aptitude in collaborating with diverse teams. When discussing management and behavioral topics, observe their depth of understanding and judgment. For off-topic questions, evaluate their agility in thinking and adaptability.",
  },
  {
    id: "Sarah",
    name: "Sarah",
    description: "Other",
    prompt:
      "Analyze the candidate's competence. Emphasize their communication efficacy, approach to problem-solving, and alignment with the desired role. In all discussions, be it related or not to the specific role, measure their adaptability and the quality of their critical thought processes.",
  },
];
  ...
  return (
    <AnimatePresence>
      <motion.p
        ...
        className="absolute w-full w-max-screen-xl md:w-1/2 top-0 h-[60px] flex flex-row justify-between mt-5 ml-8"
      >
        <Image src="/logo.svg" width={160} height={40} alt="temus" />
      </motion.p>
      {step === 3 ? (
              ...
              {recordingPermission ? (
                <div className="w-full flex flex-col max-w-[1080px] mx-auto justify-center">
                  ...
                  <span className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal mb-4">
                    This is intended for Temus staff training purposes only.
                  </span>
                  <motion.div
                    initial={{ y: -20 }}
                    animate={{ y: 0 }}
                ...
                <div className="w-full flex flex-col max-w-[1080px] mx-auto justify-center">
                  ...
                  <div className="flex flex-row space-x-4 mt-8 justify-end">
                    ...
                    <Link
                      href="https://github.com/Tameyer41/Temus"
                      target="_blank"
        ...
        <div className="flex flex-col md:flex-row w-full md:overflow-hidden">
          <div className="w-full min-h-[60vh] md:w-1/2 md:h-screen flex flex-col px-4 pt-2 pb-8 md:px-0 md:py-2 justify-center">
